...
class SlackNotifier:
    ...
    def _send_message(self, payload: Dict) -> bool:
        ...
        # Handle all retry failures
            ...
            logger.error(f"Failed to send Slack notification after {self.max_retries} attempts: {str(e)}")
            return False
    ...
    def send_success_notification(
        ...
        fields = [
            ...
            {
                "title": "Eligible Indexers",
                "value": str(len(eligible_indexers)),
                "short": True
            },
            {
        ...
        if execution_time:
            fields.append({
                ...
                "value": f"{execution_time:.2f} seconds",
                "short": True
            })
